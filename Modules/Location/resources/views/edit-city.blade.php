        ...
        <div class="main-content-wrapper">
            ...
            <section id="content-wrapper" class="content-wrapper">
                <div class="content-header-wrap">
                    <h2 class="content-title">Edit City</h2>
                    <div class="action-btns">
                        <div class="sub-head">
                            <a href="{{url ('cms-admin/cities')}}" class="vi-btn vi-btn-info">
                                ...
                                <div class="wcard">
                                    <div class="wcard-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="projectId" value="{{ $city->id }}">
