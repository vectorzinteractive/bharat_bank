        ...
        <div class="main-content-wrapper">
            ...
            <section id="content-wrapper" class="content-wrapper">
                ...
                <div class="form-wrap">
                    ...
                    <form method="POST" action="" id="admin-update-form" autocomplete="off">
                        @csrf
                                        ...
                                        <div class="create-form-wrap row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="create-form-content-wrap form-input-group inputicon">
                                                    <input name="email" class="form-control" autocomplete="off" id="email" type="text" placeholder="Email" value="{{ $user->email }}"> <span><i class="las la-envelope"></i></span>
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="create-form-content-wrap form-input-group inputicon">
                                                    <input name="name" class="form-control" autocomplete="off" id="name" type="text" placeholder="Name" value="{{ $user->name }}"> <span><i class="las la-user"></i></span>
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="create-form-content-wrap form-input-group inputicon">
                                                    <input name="password" class="form-control" autocomplete="off" id="password" type="password" placeholder="New Password (optional)"> <span><i class="las la-lock"></i></span>
                                ...
                                <div class="wcard">
                                    <div class="wcard-body">
                                        ...
                                        <div class="row row-gap-3">
                                            ...
                                            <div class="btns-row">
                                                <button type="submit" class="button primary-btn" name="login" id="registerBtn">Update</button>
                                            </div>
