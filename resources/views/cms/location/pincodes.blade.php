        ...
        <div class="main-content-wrapper">
            ...
            <section id="content-wrapper" class="content-wrapper">
                <div class="content-header-wrap">
                    <h2 class="content-title">Pincodes</h2>
                    <div class="action-btns">
                        <div class="sub-head">
                            <a href="{{ url('cms-admin/pincodes/create')}}"  class="vi-btn vi-btn-primary " id="reset-form"><i class="las la-plus"></i>Add New</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="wcard">
                            <div class="wcard-flex-header card-header">
                                <form id="filterForm" class="filter-form vi-d-flex">
                                    <div class="search-bar">
                                        ...
                                        <input class="form-control" name="filter[search]" type="search" id="search-input" placeholder="Search Pincode">
                                    </div>
                            ...
                            <div class="wcard-body">
                                ...
                                <div class="caed-body pb-0">
                                    <div id="data-block">
                                        @include('cms.location.pincode-data')
                                    </div>
                                </div>
                            </div>
                        </div>
