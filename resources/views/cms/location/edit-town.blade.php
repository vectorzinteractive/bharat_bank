        ...
        <div class="main-content-wrapper">
            ...
            <section id="content-wrapper" class="content-wrapper">
                <div class="content-header-wrap">
                    <h2 class="content-title">Edit Town</h2>
                ...
                <div class="form-wrap">
                    ...
                    <form action="" id="edit-form" method="PUT" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="wcard">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="create-form-content-wrap form-input-group">
                                                        ...
                                                        <input type="text" id="" class="form-control" name="town" placeholder="" value="{{ $town->name }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                     <div class="create-form-content-wrap form-input-group">
                                                        <label for="slug" class="form-label">Slug <span>(Optional)</span></label>
                                                        <input type="text" id="" class="form-control" name="slug" placeholder="" value="{{ $town->slug }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" id="projectId" value="{{ $town->id }}">
