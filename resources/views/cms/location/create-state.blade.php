        ...
        <div class="main-content-wrapper">
            ...
            <section id="content-wrapper" class="content-wrapper">
                <div class="content-header-wrap">
                    <h2 class="content-title">Create State</h2>
                    <div class="action-btns">
                        <div class="sub-head">
                            <a href="{{url ('cms-admin/states')}}" class="vi-btn vi-btn-info">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="create-form-content-wrap form-input-group">
                                                    ...
                                                    <input type="text" id="" class="form-control" name="state" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="create-form-content-wrap form-input-group">
                                                    <label for="state_slug" class="form-label">Slug <span>(Optional)</span></label>
                                                    <input type="text" id="" class="form-control" name="state_slug" placeholder="">
                                                </div>
                                            </div>
                                        </div>
